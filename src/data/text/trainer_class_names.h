const u8 gTrainerClassNames[][13] = {
    ...
    [TRAINER_CLASS_TEAM_AQUA] = _("Team Stall"),
    ...
    [TRAINER_CLASS_TEAM_MAGMA] = _("Team Aggro"),
    [TRAINER_CLASS_EXPERT] = _("Expert"),
    [TRAINER_CLASS_AQUA_ADMIN] = _("Stall lAdmin"),
    [TRAINER_CLASS_BLACK_BELT] = _("Black Belt"),
    [TRAINER_CLASS_AQUA_LEADER] = _("Stall Leader"),
    ...
    [TRAINER_CLASS_MAGMA_ADMIN] = _("Aggro Admin"),
    ...
    [TRAINER_CLASS_MAGMA_LEADER] = _("Aggro Leader"),
