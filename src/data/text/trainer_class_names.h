const u8 gTrainerClassNames[][13] = {
    ...
    [TRAINER_CLASS_TEAM_AQUA] = _("Team Dreidel"),
    ...
    [TRAINER_CLASS_TEAM_MAGMA] = _("Team Penta"),
    [TRAINER_CLASS_EXPERT] = _("Expert"),
    [TRAINER_CLASS_AQUA_ADMIN] = _("DreidelAdmin"),
    [TRAINER_CLASS_BLACK_BELT] = _("Black Belt"),
    [TRAINER_CLASS_AQUA_LEADER] = _("Crew Leader"),
    ...
    [TRAINER_CLASS_MAGMA_ADMIN] = _("Penta Admin"),
    ...
    [TRAINER_CLASS_MAGMA_LEADER] = _("Crews Leader"),
